...
public class Test3 {
	...
	private static void circ(Draw d, double x, double y, double r, boolean print) {
		if (r<0) r*=-1;
		...
		if (print) System.out.printf("%.5f @ (%.5f, %.5f)%n", r, x, y);
	}

	public static void main(String[] args) {
//		final double[] b = {1., 1., 6.46410161514, 15.9282032303};
		final double[] b = {1., 1., -0.464101615138, 2.07179676972};
//		final double[] b = {1., 1., -0.464101615138, 1.};
		final double r4 = 1/6.46410161514;
		final double c = 1 + r4;
		...
		for (int[] coord : coords) {
			...
			circ(d, cx, cy, 1/b[b.length-1], true);
		}
//		
